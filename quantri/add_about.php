...
if (isset($_POST['btn'])) {
    ...
    if ($title_about  == "" || $content_about == "" || $date_start == "" || $_FILES['image_about']['size'] == "") {
        ...
        $sql = "INSERT INTO about(title_about,content_about,image_about,date_start)VALUES('$title_about','$content_about','$image_about','$date_start')";
        ...
        if ($stm->execute()) {
            ...
            header("location: about.php?message=them thanh cong");
            die;
        }
    }
}
                        ...
                        <form class="form_add_pro" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form_grid">
                                <div class="text_name">
                                    ...
                                    <p><input type="text" name="title_about" id="ten1"></p>
                                    </p>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_start" id="ten1">
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="file" name="image_about" class="mt-3 ml-3">
                                    </p>
                                </div>
                                ...
                                <div class="mt-5 pt-5 ml-5">
                                    <button type="submit" name="btn" class="btn btn-info mt-5 ml-2">Thêm About</button>
                                </div>
