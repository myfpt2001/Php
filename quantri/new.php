                        ...
                        <table class="table mt-2 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="../image/<?= $c['new_image'] ?>" alt="" width="100px" height="auto">
                                    </td>
                                    <td>
                                    <p class="fix">
                                            <?= $c['new_introduce'] ?>
                                    ...
                                    <td><?= $c['date_new'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success"><a href="add_new.php"
                                                class="color_white">Thêm Bài Viết</a></button>
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_new.php?id=<?= $c['new_id'] ?>" class="color_white">Sửa</a>
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa không')"
                                                class="color_white" href="delete_new.php?id=<?= $c['new_id'] ?>">Xóa</a>
                                        </button>
