            ...
            <div class="col-xl-2 content_left">
                ...
                <div class="menu-doc">
                    ...
                    <ul class="detail_menu_stand">
                        ...
                        <li><a href="../login/logout.php"> &ensp;&ensp;<i class="fas fa-sign-out-alt"></i>&ensp;&ensp;Đăng
                                Xuất</a></li>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-xl-10 content_right pl-4 pr-0">
                <div>
                    ...
                    <div class="menu_main_right">
                        <h3 class="title_thongke mt-2 pl-5">
                            Quản Trị Khuyến Mại
                        </h3>
                            ...
                            <tbody>
                                <?php foreach ($sale as $e) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success"><a href="add_sale.php" class="link_color">Thêm Khuyến Mại</a></button>
                                            <button type="button" class="btn btn-warning">
                                                <a href="edit_sale.php?id=<?= $e['sale_id'] ?>" class="link_color">Sửa</a>
                                            </button>
                                            <button type="button" class="btn btn-danger">
                                                <a onclick="return confirm('Bạn có chắc chắn muốn xóa không')" class="link_color" href="delete_sale.php?id=<?= $e['sale_id'] ?>">Xóa</a>
                                            </button>
