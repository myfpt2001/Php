...
if (isset($_POST['btn'])) {
    ...
    if ($new_name == "" || $date_new == "" || $new_introduce == "" || $new_content == "") {
        $thongbao = "Bạn  đang bỏ trống 1 trong các trường trên";
    } else {
        if (($_FILES['new_image']['size'] > 0)) {
            $new_image = $_FILES['new_image']['name'];
        }
        $sql = "UPDATE news SET new_image='$new_image',new_name = '$new_name', new_introduce = '$new_introduce', new_content = '$new_content',date_new='$date_new'
    where new_id=$new_id";
            ...
            <div class="col-xl-10 content_right pl-0 pr-0">
                <div>
                    ...
                    <div class="menu_main_right ml-3">
                        ...
                        <form class="form_edit_new" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form_grid">
                                <div class="text_name">
                                    <input type="hidden" name="new_id" value="<?= $result['new_id'] ?>">
                                    <h5 for="" class="title_input "> Tên bài viết: </h5>
                                    <p><input type="text" name="new_name" value="<?= $result['new_name'] ?>" id="ten1">
                                    </p>
                                </div>
                                <div class="div">
                                    <h5 for="" class="title_input "> Ngày Đăng: </h5>
                                    <input type="date" name="date_new" value="<?= $result['date_new'] ?>" id="">
                                </div>
                                ...
                                <div>
                                    ...
                                    <h5 class="title_input"> Hình ảnh:
                                        ...
                                        <input type="file" id="file" name="new_image">
                                        <?php if (!empty($result['new_image'])) : ?>
                                        <input type="hidden" name="new_image" value="<?= $result['new_image'] ?>">
                                        <br>
                                        <img src="../image/<?= $result['new_image'] ?>" width="200px" alt=""
                                            class="img">
                                        <?php endif; ?>
                                        <p></p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p>
                                        <textarea name="new_introduce" id="boder" cols="40" rows="7"
                                            class="ml-3"><?= $result['new_introduce'] ?></textarea>
                                    </p>
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p>
                                        <textarea name="new_content" id="boder" cols="40" rows="7"
                                            class="ml-3"><?= $result['new_content'] ?> </textarea>
                                    </p>
                                    </p>
                                </div>
                                <div class="div"></div>
                                <div class="mt-5 pt-5">
                                    <div class="tes mt-5">
                                        <button type="submit" name="btn" class="btn btn-info mt-5  ml-2">Cập
                                            Nhật</button>
                                    </div>
