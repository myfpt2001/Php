...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-2 content_left_setting">
            ...
            <div class="col-xl-10 content_right_setting pl-0 pr-0">
                <div>
                    ...
                    <div class="menu_main_right ml-4">
                        <h3 class="title_thongke mt-3 pl-5">
                            Setting
                        </h3>
                        <table class="table table_edit_setting mt-2">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="../image/header/<?= $c['logo'] ?>" alt="" width="150px"
                                            height="auto">
                                    </td>
                                    <td>
                                        <p class="width">
                                    ...
                                    <td><?= $c['phone'] ?></td>
                                    <td>
                                        <p class="w_infor"><?= $c['information'] ?></p>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_setting.php?id=<?= $c['setting_id'] ?>"
                                                class="color_white ">Sửa</a>
                                        </button>
