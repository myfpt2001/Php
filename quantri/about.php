                    ...
                    <div class="content_right_cate ml-4">
                        ...
                        <table class="table mt-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fix_w"><?= $c['title_about'] ?></td>
                                    <td class="title_about"> <?= $c['content_about'] ?></td>
                                    <td> <img src="../image/<?= $c['image_about'] ?>" alt="" width="200px"
                                            height="auto">
                                    </td>
                                    <td><?= $c['date_start'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success "><a href="add_about.php"
                                                class="color_white">Thêm about</a></button>
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_about.php?id=<?= $c['about_id'] ?>"
                                                class="color_white">Sửa</a>
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa không')"
                                                class="color_white"
                                                href="delete_about.php?id=<?= $c['about_id'] ?>">Xóa</a>
                                        </button>
