...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-2 content_left_slider">
                        ...
                        <table class="table mt-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="../image/<?= $c['slider_image'] ?>" alt="" width="200px"
                                            height="auto">
                                    </td>
                                    <td><?= $c['URL'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success"><a href="add_slider.php"
                                                class="link_color">Thêm Slider</a></button>
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_slider.php?id=<?= $c['slider_id'] ?>"
                                                class="link_color">Sửa</a>
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa không')"
                                                class="link_color"
                                                href="delete_slider.php?id=<?= $c['slider_id'] ?>">Xóa</a>
                                        </button>
