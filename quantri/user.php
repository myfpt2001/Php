            ...
            <div class="col-xl-10 content_right pl-4 pr-0">
                <div>
                    ...
                    <div class="menu_main_right">
                        <h3 class="title_thongke">

                            User <button type="button" class="btn btn-success " style=" margin-left: 633px;">
                                <a href="add_user.php" class="color_white ">Thêm Nhân Viên</a>
                            </button>
                        </h3>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $c['user_name'] ?></td>
                                    <td> <img src="../image/<?= $c['user_image'] ?>" alt="" width="100px" height="auto">
                                    </td>
                                    <td><?= $c['phone'] ?></td>
                                    <td><?= $c['email'] ?></td>
                                    <td><?= $c['role'] ?></td>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_user.php?id=<?= $c['user_id'] ?>" class="color_white">Sửa Nhân
                                                Viên</a>
                                        </button>
                                    </td>
