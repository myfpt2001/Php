            ...
            <div class="col-xl-10 content_right pl-0 pr-0">
                <div>
                    ...
                    <div class="menu_main_right ml-3 ">
                        ...
                        <h2 class="title_edit_cate mb-0 ">Sửa Danh Mục</h2>
                        ...
                        <form action="" method="post" enctype="multipart/form-data " class="form_edit_Cate">
                            ...
                            <input type="text" name="cate_name" id="ten" value="<?= $result['cate_name'] ?>">
                            <p></p>
                            ...
                            <br>
                            <img src="../image/<?= $result['cate_image'] ?>" width="200px" alt="" class="img">
                            <?php endif; ?>
                            <p></p>
