...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-10 content_right_pro pl-3 pr-0">
                <div>
                    ...
                    <div class="menu_main_right_pro">

                        <h3 class="title_thongke mt-3 pl-5">
                            Sản Phẩm
                        </h3>
                        <table class="table mt-2 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fix_w"><?= $c['pro_name'] ?></td>
                                    <td><?= $c['price'] ?></td>
                                    <td> <img src="../image/<?= $c['pro_image'] ?>" alt="" width="150px" height="auto">
                                    </td>
                                    <td>
                                        <p class="fix">
                                            <?= $c['detail'] ?>
                                    ...
                                    <td><?= $c['quantity'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success"><a href="add_pro.php"
                                                class="color_white">Thêm Sản Phẩm</a></button>
                                        <button type="button" class="btn btn-warning">
                                            <a href="edit_pro.php?id=<?= $c['pro_id'] ?>" class="color_white">Sửa</a>
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa không')"
                                                class="color_white" href="delete_pro.php?id=<?= $c['pro_id'] ?>">Xóa</a>
                                        </button>
