...
if (isset($_POST['btn'])) {
    extract($_REQUEST);
    if ($sale_id  == "" || $sale_number == "" || $start_date == "" || $end_date == "") {
        $thongbao = "Bạn  đang bỏ trống 1 trong các trường trên";
    } else {
        $sql = "INSERT INTO sale(sale_id,sale_number,start_date,end_date)VALUES('$sale_id','$sale_number','$start_date','$end_date')";
        $stm = $conn->prepare($sql);

        if ($stm->execute()) {
            header("location: khuyenmai.php?message=them thanh cong");
            die;
        }
    }
}
// Lấy toàn bộ danh mục trên database
$sql_sale = "SELECT * FROM sales ";
                ...
                <div>
                    ...
                    <div class="menu_main_right_pro ml-4">
                        ...
                        <form class="form_add_pro" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form_grid">
                                <div class="text_name">
                                    <h5 for="" class="title_input "> Mã SaleSale </h5>
                                    <p><input type="text" name="sale_id" id="ten1"></p>
                                </div>
                                <div class="div">
                                    <h5 for="" class="title_input "> Phần trăm salesale </h5>
                                    <input type="text" name="sale_number" id="">
                                </div>
                                <div class="div">
                                    <h5 for="" class="title_input "> Ngày bắt đầuđầu </h5>
                                    <input type="date" name="start_date" id="">
                                </div>
                                <div class="div">
                                    <h5 for="" class="title_input "> Ngày kết thúc </h5>
                                ...
                                <div class="mt-5 pt-5">
                                    <button type="submit" name="btn" class="btn btn-info ml-2">Thêm Khuyến Mại</button>
                                </div>
