...
$sql = " SELECT users.user_name,comment.content,comment.comment_id,comment.date_cmt FROM comment
inner join users ON users.user_id = comment.user_id 
inner join products ON products.pro_id = comment.pro_id 
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success">
                                        <a href="xoacmt.php?id=<?= $c['comment_id'] ?> "
                                            onclick=" confirm('Bạn có chắc chắn muốn xóa không')"
                                            class="color_white">Xóa
                                            Bình Luận</a>
                                    </button>
                                </td>
                            </tr>
