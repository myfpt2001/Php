var yourDateToGo = new Date(); //here you're making new Date object
    ...
    var timing = setInterval( // you're making an interval - a thing, that is updating content after number of miliseconds, that you're writing after comma as second parameter
      function () {
        ...
        document.getElementById("countdown").innerHTML = days + "Day " + hours + "Hours " + minutes + "Minutes " + seconds + "s"; // putting number of days, hours, minutes and seconds in div, 
      ...
      function () {
        ...
        document.getElementById("countdown2").innerHTML = days2 + "Day " + hours2 + "Hours" + minutes2 + "Minutes " + seconds2 + "s";  
...
function secondExample() {
      ...
      var timing3 = setInterval(
        function () {
          ...
          document.getElementById("countdown3").innerHTML = days3 + "Day " + hours3 + "Hours " + minutes3 + "Minutes " + seconds3 + "s";
