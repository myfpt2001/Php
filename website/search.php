...
$sql = "SELECT * From products join categories on products.cate_id = categories.cate_id 
        where products.pro_name like '%$search%' or categories.cate_name like '%$search%' ";
	...
	<div class="products-all">
		...
		<div class="sale-all">
			...
			<div class="sale-all-title">
				...
				<p>The weather in summer is the time when brides have a little less choice of flower patterns. The weather is quite hot, so the flowers are often not durable. Want beautiful and durable wedding bouquets, you should choose flowers such as carnation, or white rose, or sunflower Dalat, ... You can coordinate with local flowers to create masterpieces. The bouquets of flowers are bold in nature.</p>
			</div>
		</div>
		<div class="icon-alls">
			<div class="freeship">
